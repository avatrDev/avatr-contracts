...
contract AvtarMakoNFT is ERC721, ERC721URIStorage, ERC721Pausable, Ownable {
  ...
  |__________________________________*/
   ...
   struct NFT {
    ...
    ) ERC721("Avtar NFT", "MAKO") Ownable(initialOwner){
...
function commonChecks(address to) private view {
        require(stages[currentStage].totalSupply >= _tokenIdCounter.current() + 1, "Cannot mint more NFT on this stage");
